...
"resource": {
  ...
  "tags":[{
      ...
      "vtp_dimension":["list",["map","index","16","dimension",["macro",20]]],
      ...
      "function":"__html",
      "once_per_event":true,
      "vtp_html":"\n\u003Cscript type=\"text\/javascript\"\u003Evar yahoo_conversion_id=1000204606,yahoo_conversion_label=\"OkJyCL6_hlsQv_mGzQM\",yahoo_conversion_value=500;\u003C\/script\u003E\n\u003Cscript type=\"text\/javascript\" src=\"https:\/\/s.yimg.jp\/images\/listing\/tool\/cv\/conversion.js\"\u003E\u003C\/script\u003E",
      "vtp_supportDocumentWrite":true,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "vtp_usePostscribe":true,
      ...
      "function":"__html",
      "once_per_event":true,
      "vtp_html":"\n\u003Cscript type=\"text\/gtmscript\"\u003E(function(a,b,c,f,e,d){a.hj=a.hj||function(){(a.hj.q=a.hj.q||[]).push(arguments)};a._hjSettings={hjid:298206,hjsv:5};e=b.getElementsByTagName(\"head\")[0];d=b.createElement(\"script\");d.async=1;d.src=c+a._hjSettings.hjid+f+a._hjSettings.hjsv;e.appendChild(d)})(window,document,\"\/\/static.hotjar.com\/c\/hotjar-\",\".js?sv\\x3d\");(function(){var a=jQuery(\"body\"),b=a.attr(\"data-hotjar-page\"),c=a.attr(\"data-hotjar-device\");a=a.attr(\"data-hotjar-bw\");b\u0026\u0026c\u0026\u0026a?hj(\"trigger\",b+\"-\"+c+\"-\"+a):b\u0026\u0026hj(\"trigger\",b)})();\u003C\/script\u003E",
      "vtp_supportDocumentWrite":false,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "tag_id":149
      ...
      "function":"__html",
      "once_per_event":true,
      "vtp_html":"\u003Cscript type=\"text\/javascript\"\u003Ewindow._tfa=window._tfa||[];_tfa.push({notify:\"action\",name:\"conversion\"});\u003C\/script\u003E\n\u003Cscript src=\"\/\/cdn.taboola.com\/libtrc\/3500035080-SC-prod\/tfa.js\"\u003E\u003C\/script\u003E\n\u003Cnoscript\u003E\n\u003Cimg src=\"\/\/trc.taboola.com\/3500035080-SC-prod\/log\/3\/action?name=conversion\u0026amp;item-url={encoded_page_url}\" width=\"0\" height=\"0\"\u003E\n\u003C\/noscript\u003E\n",
      "vtp_supportDocumentWrite":true,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "vtp_usePostscribe":true,
  ...
  "rules":[
    [["if",0,2],["unless",1],["add",2,3,0,118,119,127]],
    [["if",2,4,5],["add",4,7,84,85,86,87,92,93]],
    [["if",2,6],["add",5,11,12,14,27,38,80,99,100,101,120]],
    [["if",7,8],["add",5,14,30,39,80,97,102,114,128,130,132]],
    [["if",2,9],["add",6,90,91]],
    [["if",0,2,5],["add",8,25,28,36,106,116,123,125,133]],
    [["if",5,10],["add",9,10]],
    [["if",2,3],["add",13],["block",2,3,8,15,22,25,28,36,81,1,98,0,106,111,113,116,118,119,123,125,127]],
    [["if",2],["add",13,15,34,98,111,40,41,42,43,44,68,69,70,71,72,73,74,76,77,78]],
    [["if",11],["add",16,17]],
    [["if",12,13,14,15],["add",18]],
    [["if",12,14,15],["unless",13],["add",19]],
    [["if",2,16],["add",20]],
    [["if",2],["unless",17],["add",21,107,131,45,48,49,52,54,56,59,61,63,64,65,67]],
    [["if",18,19],["add",22]],
    [["if",15,20,21],["add",23,104]],
    [["if",10],["add",24,29,35,110]],
    [["if",5,7,8],["add",26,105,115,121,122,124]],
    [["if",2,22],["add",27]],
    [["if",2,24],["add",31,109]],
    [["if",15,25,26],["add",32]],
    [["if",15,27],["add",33]],
    [["if",15,28,29],["add",37,112]],
    [["if",2,30],["add",46,47,50,51,53,55,57,58,60,62,66]],
    [["if",2,31],["add",75]],
    [["if",2,32],["add",79]],
    [["if",2,33],["add",81],["block",117,118,119]],
    [["if",2,34],["unless",35],["add",81]],
    [["if",36,37],["add",81]],
    [["if",2,36],["add",1]],
    [["if",2,40],["add",82,83]],
    [["if",41],["add",88]],
    [["if",41,42],["add",89,113],["block",106]],
    [["if",41,43],["add",94]],
    [["if",2,44],["add",95]],
    [["if",41,45,46],["add",95]],
    [["if",15,47],["add",96]],
    ...
    [["if",2,49],["add",107]],
    [["if",2,50],["add",107]],
    [["if",2,51],["add",107,131],["block",118,119]],
    [["if",2,52],["add",107],["block",118,119]],
    [["if",2,53],["add",107]],
    [["if",2,54],["add",107]],
    [["if",2],["unless",55],["add",107]],
    [["if",2,56],["add",107]],
    [["if",2,57],["add",107]],
    [["if",2,58],["add",107]],
    [["if",2,59],["add",107]],
    [["if",2,60],["add",107,107]],
    [["if",2,61],["add",107]],
    [["if",2,48,62],["add",107,131]],
    [["if",2,63],["add",107,131]],
    [["if",2,64],["add",107,131]],
    [["if",2,65],["add",107,131]],
    [["if",2,66],["add",107,131]],
    [["if",7,67],["add",108]],
    [["if",68,69,70,71],["add",117,129]],
    [["if",2,76],["add",126]],
    [["if",2,77],["add",131]],
    [["if",2,78],["add",131]],
    [["if",2,23],["block",28,81,1]],
    [["if",2,38],["block",81]],
    [["if",2,39],["block",1]],
    [["if",2,72],["block",117,118,119]],
    [["if",2,73],["block",117,118,119]],
    [["if",2,74],["block",117,118,119]],
    [["if",2,75],["block",118,119]]]
},
"runtime":[
[],[]
]};
...
function(){e(m,p);w.xa.onerror=q;k.done();w=null;b()});return w}var d=0,m=[],w=null;return e(function(c,d,e){"function"===typeof e&&(e={done:e});e=f(e,k);c=/^#/.test(c)?l.document.getElementById(c.substr(1)):c.pe?c[0]:c;var h=[c,d,e];c.Fd={cancel:function(){h.stream?h.stream.abort():h[1]=a}};e.xc(h);m.push(h);w||b();return c.Fd},{streams:{},te:m,he:n})}();fc=l.postscribe}})();var gc={},hc=null;gc.m="GTM-7BF3X";var ic=null,jc="//www.googletagmanager.com/a?id="+gc.m+"&cv=283",kc={},lc={};var mc=function(){},nc=function(a){return"function"==typeof a},oc=function(a){return"string"==ta(a)},pc=function(a){return"number"==ta(a)&&!isNaN(a)},qc=function(a){return Math.round(Number(a))||0},rc=function(a){return"false"==String(a).toLowerCase()?!1:!!a},sc=function(a){var b=[];if(oa(a))for(var c=0;c<a.length;c++)b.push(String(a[c]));return b},tc=function(a){return a?a.replace(/^\s+|\s+$/g,""):""},uc=function(a,b){if(!pc(a)||!pc(b)||a>b)a=0,b=2147483647;return Math.floor(Math.random()*(b-a+1)+
